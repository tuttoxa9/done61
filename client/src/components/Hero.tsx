...
export default function Hero() {
  ...
  return (
    <section className="relative pt-14 pb-16 overflow-hidden" itemScope itemType="https://schema.org/JobPosting">
      <PreloadImages />
      <BackgroundElements />
      ...
      <div className="container-custom">
        <div className="flex flex-col lg:flex-row items-center gap-8">
          <div className="lg:w-1/2 z-10">
            ...
            <h1 className="font-bold text-4xl md:text-5xl lg:text-6xl mb-5 leading-tight tracking-tight" itemProp="title">
              Твой <span className="animated-gradient-text animate-text-gradient">быстрый старт</span> в доставке
            </h1>
            <p className="text-lg text-foreground/70 mb-6 max-w-xl" itemProp="description">
